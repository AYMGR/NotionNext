...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AYiMuGA', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://muga.blog', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 笔记，第二大脑', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ayimugare@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/AYMGR', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/ayimugare', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  FONT_SANS: [// 无衬线字体 例如'LXGW WenKai'
    'Bitter', '"Noto Sans SC"', '"PingFang SC"', '"LXGW WenKai"', '-apple-system', 'BlinkMacSystemFont', '"Hiragino Sans GB"',
  ...
  FONT_SERIF: [// 衬线字体 例如'LXGW WenKai'
    'Bitter', '"Noto Serif SC"', '"LXGW WenKai"', 'SimSun', '"Times New Roman"', 'Times', 'serif',
